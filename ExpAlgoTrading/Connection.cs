...
namespace ExpAlgoTrading {
    ...
    sealed class DummyConnection : IConnection {
        public DummyConnection() {
            // опционально, если необходимо - инициализировать числовые значения, связанные с сервисом
            // торговая комиссия, комиссия за вывод средств, минимальный депозит
        }
