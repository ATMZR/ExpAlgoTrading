...
global using Service = ExpAlgoTrading.BinanceConnection; // CoinbaseConnection, DummyConnection, etc.
global using DataAnalyzer = ExpAlgoTrading.TechnicalIndicatorsAnalyzer;
